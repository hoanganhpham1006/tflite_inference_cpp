...
int main( )
{
    ...
    image1 = imread("/home/anhph/projects/bokeh/tflite_inference_cpp/IMG_0489.HEIC",CV_LOAD_IMAGE_COLOR);
    if( !image1.data ) { printf("Error loading image1 \n"); return -1;}
    image2 = imread("/home/anhph/projects/bokeh/tflite_inference_cpp/IMG_1993.HEIC",CV_LOAD_IMAGE_COLOR);
